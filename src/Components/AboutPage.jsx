...
function AboutPage() {
  return (
    <div className="h-full flex flex-col justify-center px-8 text-white">
      <h1 className="text-4xl font-bold mb-4">EMS Pro</h1>

      <p className="text-lg text-indigo-100 leading-relaxed">
        EMS Pro is a powerful EMSloyee Management System designed for modern
        organizations. Manage EMSloyees, track performance, and streamline
      ...
      <div className="mt-6 space-y-2 text-indigo-200 text-sm">
        ...
        <p>✔ Real-Time EMSloyee Insights</p>
